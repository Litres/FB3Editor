...
Ext.define(
	'FBEditor.view.panel.resources.tpl.LargeResource',
	{
		...
		constructor: function ()
		{
			...
			me.html = '<tpl for=".">' +
				'<tpl if="isFolder"><div class="resource-thumb-wrap resource-large-thumb resource-folder-wrap">' +
				'<tpl else><div class="resource-thumb-wrap resource-large-thumb"></tpl>' +
